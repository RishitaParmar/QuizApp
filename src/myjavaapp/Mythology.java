 ...
 * @author Lenovo
 */
public class Mythology extends javax.swing.JFrame {
    ...
    String[] question = {
    "Q.1 Who wrote down the epic Mahabharata when Vyasa was dicting?",
        "Q.2 Which one is First avatar of Lord Vishnu from his Dashavatar?",
        "Q.3 In which Yuga, Shree Rama was born in Ayodhya?",
        "Q.4 Sati (wife of Lord Shiva) was the daughter of_______",
        "Q.5 Who brought the River goddess Ganga to Earth from the heavens?",
        "Q.6 For how many days was the battle of kurukshetra was fought?",
        "Q.7 From which forest Sita was abducted by the Ravana?",
        "Q.8 Who is known as the mother of King Dhritarashtra?",
        "Q.9 What is the name of the only sister of 100 Kaurav brothers",
        "Q.10 How many children was born to Devaki and Vasudev before Krishna birth",
    };
    
    String[][] options = {
        {"Narada","Viswakarma","Ganesh","Shiv","Ganesh"},
        {"Matsya","Kurma","Varah","Narsimbha","Matsya"},
        {"Satya Yuga","Treta Yuga","Dwapara Yuga","Kali Yuga","Treta Yuga"},
        {"Kubera","Daksha Prajapati","Himavan","None of the above","Daksha Prajapati"},
        {" Shree Rama","Krishna","Bhagiratha","Raja Harishchandra","Bhagiratha"},
        {"12","18","15","8","18"},
        {"Ashok Vatika","Kamyaka Forest","Dandaka forest","None of the above","Dandaka forest"},
        {"Amba","Ambika","Ambalika","Sathyavathi","Ambika"},
        {"Ulupi","Uttara","Dussala","Hidimba","Dussala"},
        {"3","5","7","8","7"},
    };
  ...
  /*  public void paint(Graphics g){
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("MYTHOLOGY QUIZ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mythology.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
