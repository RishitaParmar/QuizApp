 ...
 * @author Lenovo
 */
public class SciencePage extends javax.swing.JFrame {
    ...
    String[] question = {
    "Q.1 Which among the following was the first vaccine ever to be developed?",
     "Q.2 Cooking gas mainly consists of:",
     "Q.3 Which of the following is not a virus disease?",
    "Q.4 Which of the following gas is reduced in the reduction process?",
     "Q.5 Which of the following compound is mainly used in hand sanitizer?",
     "Q.6 Which of the following enzymes is not present in the human stomach?",
     "Q.7 What is the basic unit of our neural system?",
      "Q.8 What is the unit of wavelength?",
      "Q.9 What is the other name of Newton's first law of motion?",
      "Q.10 What is the color of SO2 gas?",
    };
    
    String[][] options = {
        {"Cholera","Smallpox","Rabies","Tetanus","Smallpox"},
        {"Methane and Ethane","Ethylene and carbon monoxide","Butane and Isobutane","Acetylene and hydrogen","Butane and Isobutane"},
        {"Salmonellosis","Ranikhet disease","Laryngotracheitis","Fowl Pox","Salmonellosis"},
        {"Oxygen","Helium","Carbon","Hydrogen","Hydrogen"},
        {"Aldehyde","Acetic acid","Alcohol","Ketone","Alcohol"},
        {"Pepsin","Hydrochloric acid","Mucus","Trypsin","Trypsin"},
        {"Neutron","Neuron","Nephron","Nucleon","Neuron"},
        {"Hertz","Diopter","Faraday","Meter","Meter"},
        {"Action-reaction","Change in momentum","Law of inertia","Constant momentum","Law of inertia"},
        {"Blue","Gray","Colorless","Brown","Colorless"},
    };
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SciencePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
