 ...
 * @author Lenovo
 */
public class MyMathsPage extends javax.swing.JFrame {
    
    String[] question = {
    "Q.1 What is the next prime number after 7?",
     "Q.2 Solve  3 + 6 * (5 + 4) / 3 - 7?",
     "Q.3 What is 6% Equals to?",
     "Q.4 What number comes before 9091 ?",
     "Q.5 How Many Months make a Century?",
     "Q.6 What is the value of PI ?",
     "Q.7 50 Times of 8 is equal to?",
      "Q.8 If A's age is 27 years in 2011.What was his age in 2003?",
      "Q.9 19 + _______ = 42",
      "Q.10 Smallest number of 4 digits - largest number of 3 digits?",
    };
    
    String[][] options = {
        {"13","12","14","11","11"},
        {"11","16","14","15","14"},
        {"0.06","0.6","0.006","0.0006","0.06"},
        {"9099","9091","9109","None of these","None of these"},
        {"12","120","1200","12000","1200"},
        {"3.14","3.06","2.14","3.16","3.14"},
        {"80","400","800","4000","400"},
        {"17 years","37 years","20 years","19 years","19 years"},
        {"23","61","0","42","23"},
        {"1","100","0","999","1"},
    };
...
//        getSelectedOption(jRadioButton_op1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyMathsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyMathsPage().setVisible(true);
            }
        });
    }
