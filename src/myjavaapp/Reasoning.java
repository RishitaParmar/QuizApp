...
public class Reasoning extends javax.swing.JFrame {
    ...
    String[] question = {
        "Q.1 If NOIDA is written as OPJEB, then what will be the code for DELHI?",
        "Q.2 If CAT is coded as PATC, JOY is coded as POYJ; similarly the word WING will be coded as______",
        "Q.3 Which number is wrong in the series 2, 6, 15, 31, 56, 93?",
        "Q.4 The day before yesterday was Saturday. What will be the day after tomorrow?",
        "Q.5 Drama : Stage :: Tennis : ?",
        "Q.6 Which of the following is different from others?",
        "Q.7 Which of the following pairs of words are differently related?",
        "Q.8 A thermometer is to temperature as a compass is to _____",
        "Q.9 Raman says Anuj's mother is the only daughter of my mother. How is Anuj related to Raman?",
        "Q.10 A factory always has ____",
    };
    
    String[][] options = {
        {"EFMAK","EFAMK","EFMIJ","EFMIK","EFMIJ"},
        {"PIGNW","PINGW","PGNIW","PIWGN","PINGW"},
        {"6","31","56","93","93"},
        {"Thursday","Friday","Wednesday","Monday","Wednesday"},
        {"Net","Court","Tournament","Racket","Court"},
        {"Barber","Blacksmith","Tailor","Carpenter","Barber"},
        {"Kind : Cruel" ,"Slow : Sluggish" ,"Stale : Fresh" ,"Truth : Lie","Slow : Sluggish"},
        {"Needle","Pressure","Direction","None of the above","Direction"},
        {"Brother","Nephew","Father","None of the above","Nephew"},
        {"Files","Workers","Air Conditioner","Chimneys","Workers"},
    };
  ...
  /*  public void paint(Graphics g){
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("REASONING QUIZ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reasoning.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
