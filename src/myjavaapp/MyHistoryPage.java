 ...
 * @author Lenovo
 */
public class MyHistoryPage extends javax.swing.JFrame {
...
//        getSelectedOption(jRadioButton_op1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyHistoryPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyHistoryPage().setVisible(true);
            }
        });
    }
