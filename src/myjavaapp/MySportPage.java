 ...
 * @author Lenovo
 */
public class MySportPage extends javax.swing.JFrame {
    
    String[] question = {
    "Q.1 Which among the following is the National Sports of USA?",
     "Q.2 India's 1st one day international with which country?",
     "Q.3 Which state will host 2020 national games of India?",
     "Q.4 When Commonwealth Games were hosted in India?",
     "Q.5 Which sport's term is 'Brooklyn Nets'?",
    };
    
    String[][] options = {
        {"Bowling","Baseball","Rugby","Table Tennis","Baseball"},
        {"England","Australia","Shri Lanka","New Zealand","England"},
        {"Jharkhand","Kerala","Goa","Uttarakhand","Goa"},
        {"2006","2002","2010","2014","2010"},
        {"Basketball","Rugby","Baseball","Football","Basketball"},
    };
 ...
 /*   public void getAnswer(JRadioButton rbutton)
    ...
    */
    ...
    {
        jLabel_correctAns.setEnabled(true);
...
//        getSelectedOption(jRadioButton_op1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MySportPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MySportPage().setVisible(true);
            }
        });
    }
