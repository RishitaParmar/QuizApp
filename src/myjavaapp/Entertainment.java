...
public class Entertainment extends javax.swing.JFrame {
    ...
    String[] question = {
    //"Q.1 Which firm is called invisible and intangible?",
        "Q.1 ‘Blue subscriber service’ is a premium service of which social media company?",
     //   "Q.2 Who is the famous author of the Harry Potter book series?",
        "Q.2 Actor Sushant Singh Rajput was born in which city ? ",
        "Q.3 Famous Bollywood Actress “Priyanka Chopra” first movie in Hollywood was _______",
        "Q.4 At what age, legend actor Kishore Kumar died ?",
        "Q.5 Who was the director of 3 idiot movie ?",
    };
    
    String[][] options = {
        {"Facebook","Twitter","Whatsapp","Instagram","Twitter"},
        //{"Colin Farrell","Brendan Fraser","Austin Butler","Bil Nighy","Brendan Fraser"},
        //{"George R. R. Martin","N. K. Jemisin","J. R. R. Tolkien","J. K. Rowling","J. K. Rowling"}
        {"Ranchi","Bhopal","Patna","Mumbai","Patna"},
        {"Baywatch","Terminator","Force","Women in Black","Baywatch"},
        {"59","72","67","58","58"},
        {"Sanjay Leela Bhansali","Prakash Jha","Rajkumar Hirani","Aamir Khan","Rajkumar Hirani"}
    };
  ...
  /*  public void paint(Graphics g){
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("ENTERTAINMENT QUIZ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jRadioButton_op1, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(136, 136, 136)
