...
public class SportsPage extends javax.swing.JFrame {
    ...
    String[] question = {
    "Q.1 When was the first Common Wealth Games held?",
     "Q.2 In which sports is the participant called pugilist?",
     "Q.3 The term ‘Butterfly Stroke’ is referred to in which sport?",
    "Q.4 Thomas Cup is related to_______",
     "Q.5 The number of players in each side in Water Polo is________",
     "Q.6 Which was the first country to host the Asian Games?",
     "Q.7 Where is the headquarters of the International Olympic Committee located?",
      "Q.8 ‘Free throw’ is associated with:",
      "Q.9 Who is named as the Flying Sikh of India?",
      "Q.10 2018 FIFA World Cup would be held in______",
      "Q.11 The first World Cup in cricket was held in______",
      "Q.12  Who is the first Indian cricketer to take a hat-trick of wickets in a Test?",
      "Q.13 Where did the game of Chess originate?",
      "Q.14 How many players are there on each side in the game of basketball?",
      "Q.15 Bull’s eye is used in the game of"
    };
    
    String[][] options = {
        {"1930","1934","1938","1948","1930"},
        {"Sprinter","Boxing","Wrestling","Javelin throw","Boxing"},
        {"Wrestling","Volleyball","Tennis","Swimming","Swimming"},
        {"Tennis","Cricket","Basketball","Badminton","Badminton"},
        {"6","7","8","9","7"},
        {"China","Japan","India","Korea","India"},
        {"Italy","France","Belgium","Switzerland","Switzerland"},
        {"Basketball","Hockey","Volleyball","Football",""},
        {"Milkha Singh","Joginder Singh","Ajit Pal Singh","Mohinder Singh","Milkha Singh"},
        {"Qatar","France","Russia","Netherlands","Russia"},
        {"1971","1973","1975","1977","1975"},
        {"B.S. Bedi","B.S. Chandrasekhar","E.A.S. Prasanna","Harbhajan Singh","Harbhajan Singh"},
        {"India","Persia","Arabia","Europe","India"},
        {"5","6","7","8","5"},
        {"Shooting","Boxing","Polo","Baseball","Shooting"}
    };
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SportsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
