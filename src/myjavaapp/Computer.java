...
public class Computer extends javax.swing.JFrame {
    ...
    String[] question = {
        "Q.1 Which of the following language does the computer understand?",
        "Q.2  Which of the following is not a type of computer code?",
        "Q.3 Which of the following is designed to control the operations of a computer?",
        "Q.4 Which of the following are physical devices of a computer?",
        "Q.5 Which of the following can access the server?",
    };
    
    String[][] options = {
        {"C Language","Assembly Language","Binary Language","BASIC","Binary Language"},
        {"EDIC","ASCII","BCD","EBCDIC","EDIC"},
        {"User","Application software","System software","Utility software","System software"},
        {"Hardware","Software","System Software","Package","Hardware"},
        {"Web Client","User","Web Browser","Web Server","Web Client"},
    };
