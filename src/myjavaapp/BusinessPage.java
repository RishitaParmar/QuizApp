 ...
 * @author Lenovo
 */
public class BusinessPage extends javax.swing.JFrame {
    ...
    String[] question = {
    "Q.1 Individual Ownership is called as?",
     "Q.2  Who takes no active part in Business?",
     "Q.3 Whose property is not liable for the debts of a company?",
    "Q.4 In case of death or insolvency of a partner the firm is?",
     "Q.5 Maximum number of partners allowed in Banking Business?" ,
     "Q.6 In which firm the agreement is Oral or Written?",
     "Q.7 Who is not entitled to the share of profits?",
      "Q.8 Minimum Members required in a PVT. Ltd firm are?",
      "Q.9 Companies Act 2013 govern?",
      "Q.10 Which firm is called invisible and intangible?"
    };
    
    String[][] options = {
        {"Joint Trade Business","Sole Proprietorship","Co-Operative Society" ,"Partnership","Sole Proprietorship"},
        {"CEO","Managing Director","Dormant Partner","Minor Partner","Dormant Partner"},
        {"Qwners","Shareholders","Employee","Minor Partner","Minor Partner"},
       {"Dissolved","Carried on","New owner","None of the above","Dissolved"},
        {"Infinite","10","20","50","50"},
        {"Partnership","Solo Partnership","HUF","Co-operative Society","Partnership"},
        {"Manager","Shareholder","Partners","Nominal Partner","Nominal Partner"},
        {"5","2","10","50","2"},
        {"Partnership firm","Co-Operative Society","Joint Stock Company","Sole Proprietorship","Joint Stock Company"},
        {"Partnership","HUF","Company","Co-Operative Society","Company"},
    };
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusinessPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
